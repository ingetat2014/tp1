...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 17 Avril 2018 à 08:16
...
ALTER TABLE `message`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_B6BD307FA21BD112` (`personne_id`);
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `FK_B6BD307FA21BD112` FOREIGN KEY (`personne_id`) REFERENCES `personne` (`id`) ON DELETE CASCADE;
